...
void TextureManager::draw(const std::string& id, const int x, const int y, const int width, const int height, SDL_Renderer * pRenderer, SDL_RendererFlip flip) {
...
void TextureManager::drawFrame(const std::string& id, const int x, const int y, const int width, const int height, const int currentRow, const int currentFrame, SDL_Renderer * pRenderer, SDL_RendererFlip flip) {
	...
	srcRect.x = width * currentFrame == 0 ? 1 : currentFrame;
	srcRect.y = height * (currentRow == 0 ? currentRow : currentRow - 1);
